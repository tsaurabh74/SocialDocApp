<div class="col-md-3 static">
                        <div class="profile-card">
                            <img src="profile/<%=session.getAttribute("profile")%>" alt="user" class="profile-photo" />
                            <h5><a href="timeline.jsp" class="text-white"><%=session.getAttribute("username")%></a></h5>
                            <a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 1,299 followers</a>
                        </div><!--profile card ends-->
                        <ul class="nav-news-feed">
                            <li><i class="icon ion-ios-paper"></i><div><a href="timeline.jsp">My Newsfeed</a></div></li>
                            <li><i class="icon ion-ios-people"></i><div><a href="newsfeed-people-nearby.html">People Nearby</a></div></li>
                            <li><i class="icon ion-ios-people-outline"></i><div><a href="doctor_friends.jsp">Friends</a></div></li>
                            <li><i class="icon ion-chatboxes"></i><div><a href="#">Messages</a></div></li>
                            <li><i class="icon ion-images"></i><div><a href="doctor_album.jsp">Images</a></div></li>
